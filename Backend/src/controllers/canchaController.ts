...
export const getCanchas = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const getCanchaById = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
// Eliminar una cancha
export const deleteCancha = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
